...
module.exports = {
  name: "isim",
  aliases: ["i", "name", "k", "kayıt", "e", "kız", "erkek"],
  ...
  function embed(msg) {
    ...
    if(![settings.RegisterStaff].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission(1)) return embed(`Bu komudu kullanmak için gerekli rollere veya izinlere sahip değilsin.`)
